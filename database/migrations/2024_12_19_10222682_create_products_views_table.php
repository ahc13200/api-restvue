...
return new class extends Migration {
    ...
    public function up()
    {
        ...
        $db->statement("CREATE OR REPLACE VIEW admin.products_view(id,provider_id,product_id,product_name,image,price,coin_acronym,product_code,stock_quantity,unit_acronym) as 
