...
/**
 * Este es la clase modelo para la tabla nomenclature.coins.
 *
...
class Coin extends BaseModel
{
     ...
     * @var string
     */
    protected $table = 'nomenclature.coins';
    ...
    {
        return $this->belongsTo(Provider_product::class, 'coin_id', 'id');
    }


    protected function rules($scenario = 'create')
    {
        $rules = include(__DIR__ . '/../Rules/CoinRule.php');
